...
import type { DeviceFrequency } from "@/amfitrackSDK";
...
export function UnknownRow({
  ...
  return (
    ...
    >
      <div
        className={cn(
          "size-2 rounded-full shrink-0 bg-zinc-500",
          "ring-2 ring-offset-1 ring-offset-sidebar-accent ring-zinc-500/30",
        )}
      />
